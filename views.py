...
# Importing Dataset!
data = pd.read_excel(r'C:\Users\LENOVO\Data_Onemg.xlsx')
...
def Ingrid_match(query, choice, limit=50):
    ...
    if request.method == 'POST':
        ...
        if Ingrid != '':
            ...
            for item in update1:
                ...
                matched_ingrid=[strng for strng in string1_split if strng.lower() in item.lower() and count<=length]
                count = count+ 1
